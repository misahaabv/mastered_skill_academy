  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await fetch(
        ...
        {
          method: "POST",
          mode: "no-cors", // We can't read the response with 'no-cors'
          headers: {
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 hover:border-primary rounded px-3 py-2 mt-1 focus:border-primary focus:ring-2 focus:ring-primary/30"
          ...
          <div className="flex-1 flex flex-col gap-6 justify-between">
            <div className="bg-white rounded-2xl shadow-xl p-6 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <a href="mailto:allmasteredskills@gmail.com" className="hover:underline">
            ...
            {/* Google Map */}
            <div className="rounded-2xl overflow-hidden shadow-xl mt-4 flex-1">
              <iframe
                title="Location"
