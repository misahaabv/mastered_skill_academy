...
export default function Contact() {
  return (
    <>
      <Navbar />
      <section className="bg-[#eaf1fc] py-10 px-4 md:px-0 min-h-[70vh]">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-primary text-center">Contact Us</h1>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <form className="flex-1 bg-white rounded-2xl shadow-xl p-8 space-y-5 mb-5 md:mb-0">
              ...
              <div>
                ...
                <input type="text" className="w-full border border-gray-300 hover:border-primary rounded px-3 py-2 mt-1" placeholder="Your Name" required />
              </div>
              <div>
                <label className="font-semibold">Email</label>
                <input type="email" className="w-full border border-gray-300 hover:border-primary rounded px-3 py-2 mt-1" placeholder="Your Email" required />
              </div>
              <div>
                <label className="font-semibold">Phone</label>
                <input type="tel" className="w-full border border-gray-300 hover:border-primary rounded px-3 py-2 mt-1" placeholder="Phone Number" required />
              </div>
              <div>
                <label className="font-semibold">Message</label>
                <textarea className="w-full border border-gray-300 hover:border-primary rounded px-3 py-2 mt-1" placeholder="Type your message..." required></textarea>
              </div>
